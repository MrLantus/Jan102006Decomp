...
namespace RBX
{
	...
	{
		insert(lego_1, 253, 254, 253, "White");
		insert(lego_2, 193, 199, 196, "Grey");
		insert(lego_3, 255, 249, 137, "Light yellow");
		insert(lego_5, 242, 234, 164, "Brick yellow");
		insert(lego_6, 194, 240, 184, "Light green (Mint)");
		insert(lego_9, 255, 204, 242, "Light reddish violet");
		insert(lego_11, 60, 220, 242, "Pastel Blue");
		insert(lego_12, 255, 140, 25, "Light orange brown");
		insert(lego_18, 230, 140, 77, "Nougat");
		insert(lego_21, 242, 32, 0, "Bright red");
		insert(lego_22, 210, 100, 160, "Med. reddish violet");
		insert(lego_23, 25, 64, 171, "Bright blue");
		insert(lego_24, 255, 255, 0, "Bright yellow");
		insert(lego_25, 100, 60, 48, "Earth orange");
		insert(lego_26, 0, 0, 16, "Black");
		insert(lego_27, 105, 110, 105, "Dark grey");
		insert(lego_28, 25, 130, 60, "Dark green");
		insert(lego_29, 204, 242, 160, "Medium green");
		insert(lego_36, 255, 230, 140, "Lig. Yellowich orange");
		insert(lego_37, 60, 151, 56, "Bright green");
		insert(lego_38, 180, 70, 25, "Dark orange");
		insert(lego_39, 230, 242, 255, "Light bluish violet");
		insert(lego_40, 210, 255, 242, "Transparent");
		insert(lego_41, 242, 205, 170, "Tr. Red");
		...
		insert(lego_104, 130, 32, 130, "Bright violet");
		insert(lego_105, 255, 170, 48, "Br. yellowish orange");
		insert(lego_106, 255, 140, 48, "Bright orange");
		insert(lego_107, 25, 128, 150, "Bright bluish green");
		insert(lego_108, 110, 100, 64, "Earth yellow");
		insert(lego_110, 64, 64, 140, "Bright bluish violet");
		insert(lego_111, 110, 110, 170, "Tr. Brown");
